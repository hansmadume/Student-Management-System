        ...
        <div class="relative w-full max-w-md">
            <div class="mb-6 flex justify-center">
                <a href="/"
                    ...
                    <span class="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-indigo-500">
            ...
            <div
                ...
                <div class="space-y-8">
                    <div class="text-center">
                        <div
                            class="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-violet-600 to-indigo-500 text-white shadow-lg shadow-indigo-200">
                        ...
                        <h1 class="mt-3 text-3xl font-bold tracking-tight text-slate-900">Create account</h1>
                        <p class="mt-2 text-sm text-slate-500">
                            Register to access student records, departments, courses, and analytics.
                        </p>
                    </div>

                    <form method="POST" :action="registerUrl" class="space-y-5">
                        ...
                        <div>
                            ...
                            <p v-for="message in errors.name || []" :key="message" class="mt-2 text-sm text-red-600">
                                {{ message }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-slate-400">
                                    <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                        <path d="M9 12.5 11 14.5 15.5 10" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M6 10h12v10H6V10Z" stroke="currentColor" stroke-width="1.8"
                                            stroke-linejoin="round" />
                                        <path d="M8 10V8a4 4 0 0 1 8 0v2" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg>
                                </span>
                            ...
                            <p v-for="message in errors.password_confirmation || []" :key="message"
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-center text-sm text-slate-600">
                        ...
                        <a :href="loginUrl" class="font-bold text-indigo-600 transition hover:text-indigo-800">
                            Log in
                        </a>
                    </div>
                </div>
